...
public class Converters {
  ...
  public static BroadcastRequest serverBroadcastRequestToClient(io.swagger.model.BroadcastRequest body) {
    return
        new BroadcastRequest()
            ...
            .signature(new Signature().value(body.getSignature().getValue()));
  }
  ...
  public static TransactionInformation createTransaction(String sourceKey, String destKey, long amount, String hash, String receiveHash, String transSignature) {
    return new TransactionInformation()
        .sourceKey(sourceKey)
        .destKey(destKey)
